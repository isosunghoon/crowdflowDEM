...
def add_human(t):
    if t <= 1000:
        ...
        if t % 20 == 0:
            h = Human(pos = (np.random.randint(110, 490), 0), direction = (0,1), speed = s, color = '#179BAE', radius = simulation['radius'], mass = simulation['mass'])
            humans.append(h)
        if t % 20 == 1:
            h = Human(pos = (np.random.randint(110, 490), 600), direction = (0,-1), speed = s, color = '#4158A6', radius = simulation['radius'], mass = simulation['mass'])
            humans.append(h)
        if t % 20 == 2:
            h = Human(pos = (0, np.random.randint(110, 490)), direction = (1, 0), speed = s, color = '#FF8343', radius = simulation['radius'], mass = simulation['mass'])
            humans.append(h)
        if t % 20 == 3:
            h = Human(pos = (600, np.random.randint(110, 490)), direction = (-1, 0), speed = s, color = '#F1DEC6', radius = simulation['radius'], mass = simulation['mass'])
            humans.append(h)
...
obstacles.append(Obstacle([Vec((0,0)),Vec((100,0)),Vec((100,100)),Vec((0,100))]))
obstacles.append(Obstacle([Vec((500,0)),Vec((600,0)),Vec((600,100)),Vec((500,100))]))
obstacles.append(Obstacle([Vec((0,500)),Vec((100,500)),Vec((100,600)),Vec((0,600))]))
obstacles.append(Obstacle([Vec((500,500)),Vec((600,500)),Vec((600,600)),Vec((500,600))]))
