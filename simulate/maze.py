...
def add_human(t):
    if t==2:
        h = Human(pos = (100, 0), direction = (0,1), speed = 100, color = '#179BAE', radius = simulation['radius'], mass = simulation['mass'])
        humans.append(h)
def find_neighbor():
    #LCM
    k                = 1.004
...
simulation = {'eye':info['eye'],'alpha':info['alpha'], 'beta':info['beta'], 'will_coef':info['will_coef'], 'stiffness':info['stiffness'], 'restitution':info['restitution'], #hyperparameter
              'frame':2500, 'dt':0.004, 'w': 600, 'h': 600, 'radius':10, 'mass':500, 'speed_mean':info['speed_mean'], 'speed_var':info['speed_var'], 'padding':10, #environment variable
...
obstacles.append(Obstacle([Vec((0,0)),Vec((50,0)),Vec((50,200)),Vec((150,200)),Vec((150,300)),Vec((250,300)),Vec((250,400)),Vec((350,400)),Vec((350,500)),Vec((450,500)),Vec((450,600)),Vec((0,600))]))
obstacles.append(Obstacle([Vec((150,0)),Vec((150,100)),Vec((250,100)),Vec((250,200)),Vec((350,200)),Vec((350,300)),Vec((450,300)),Vec((450,400)),Vec((550,400)),Vec((550,600)),Vec((600,600)),Vec((600,0))]))
