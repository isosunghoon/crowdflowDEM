...
def read_pred_and_gt(pred_file, gt_file=None):
    """
    Read prediction and optionally ground truth data.
    
    Parameters:
    - pred_file: str, path to the prediction file.
    - gt_file: str, path to the ground truth file (optional).
    
    Returns:
    - pred_data: dict, containing prediction data.
    - gt_data: dict, containing ground truth data (if provided).
    """
    ...
    # Read ground truth data (if provided)
    gt_data = {}
